...
public class InteractWithDatabase {
    ...
    private static void runConsole(Database database)
    {
        ...
        while (line != null && !line.equals("exit")) {
            ...
            else if (parts[0].equals("MostFoulingTeam"))
            {
                database.foulMost();
                printDescription();
            }
            else if (parts[0].equals("MostFoulingPlayer"))
            {
                database.foulMostPlayer();
                printDescription();
            }

            else if (parts[0].equals("OverTimeGames"))
            {
                database.mostOT();
                printDescription();
            }
    ...
    private static String getConnectionUrl(String configFileName)
    {
        ...
        connectionUrl = (prop.getProperty("msSqlServerJdbcConnectionLink"));

        if (connectionUrl == null) {
            System.out.println("MS SQL Server JDBC connection link not provided.");
            System.exit(1);
        }
    ...
    private static void printTeam() {
        ...
        System.out.println(getPrintHelpCommands("MostFoulingTeam", "- Teams that foul the most."));
        System.out.println("==========================================================================================================================================================");
    }
    ...
    private static void printPlayer() {
        ...
        System.out.println(getPrintHelpCommands("MostFoulingPlayer", "- Players That foul the most."));
        System.out.println("===========================================================================================================================================================");
    }
    ...
    private static void printOthers() {
        ...
        System.out.println(getPrintHelpCommands("OverTimeGames", "- Returns all overtime games."));
...
class Database {
    ...
    public void foulMost()
    {
        try {
            String sql = "SELECT team_name snt,fouls FROM teams\n" +
                    "ORDER by fouls DESC\n" +
            ...
            {
                columns = new String [numColumns];
                columns[0] = resultSet.getString("snt");
                columns[1] = resultSet.getString("fouls");
                output += getOutput(numColumns, columns) + "\n";
            }
            output += "-------------------------------------------------------\n";
            System.out.println(output);
    ...
    public void foulMostPlayer()
    {
        try {
            String sql = "SELECT player_name, fouls FROM playersStats\n" +
                    "ORDER by fouls DESC \n" +
                    "OFFSET 0 ROWS FETCH NEXT 5 ROWS ONLY;";
    ...
    {
        try {
            String sql = "SELECT gameDetails.game_date, home_team,away_team,OT from gameDetails\n" +
                    "where OT >0\n" +
                    "ORDER by OT desc;";
            ...
            {
                columns[0] = resultSet.getString("game_date");
                columns[1] = resultSet.getString("home_team");
                columns[2] = resultSet.getString("away_team");
                columns[3] = resultSet.getString("OT");
                output += getOutput(numColumns, columns) + "\n";
            }
            output += "---------------------------------------------------------------------------------------------------------------\n";
            System.out.println(output);
